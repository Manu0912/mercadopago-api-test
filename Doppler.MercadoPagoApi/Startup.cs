...
namespace Doppler.HelloMicroservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors();
            services.AddSingleton<MercadoPagoApi.Payment.ICardTokenClient, MercadoPagoApi.Payment.CardTokenClient>();
            services.AddSingleton<MercadoPagoApi.Payment.IPaymentService, MercadoPagoApi.Payment.PaymentService>();
